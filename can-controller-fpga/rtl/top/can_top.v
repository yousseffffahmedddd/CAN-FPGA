...
module can_top (
    ...
    // The engine request is blocked during Bus-Off. tx_start provides the
    // direct RTS pulse; the stored TXREQ keeps the request alive afterward.
    wire engine_txreq =
        (tx_start || (txb0_txreq && txbuf_ready)) && !pe_bus_off;
